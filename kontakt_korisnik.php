...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        // Obaveštenje ostavljamo preko JavaScripta
    } else {
...
<head>
    ...
    <title>Kontaktiraj administratora</title>
    <link rel="stylesheet" href="kontakt_korisnik.css">
</head>
<body>
    <div class="container">
        <a href="newVersion_usertable.html" class="btn-nazad">Nazad</a>
        <h1>Kontaktiraj administratora</h1>
        <form id="kontakt_korisnik" action="kontakt_korisnik.php" method="post">
            <!-- Ime i prezime -->
    ...
    <script src="kontakt_korisnik_forma.js"></script>
</body>
</html>
