...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/add-vehicle.css">
    <script src="../../public/js/add-vehicle.js" defer></script>
</head>
<body>
    <div class="form-container">
        ...
        <form id="dodajForm" action="../../src/admin/admin-add-vehicle.php" method="post" novalidate>
